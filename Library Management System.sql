...
--Creating a stored procedure list 
CREATE PROC dbo.LibraryManagementSystemProcedure_1
AS
...
GO
	...
	Publisher_Publisher_PublisherPhone VARCHAR(50) NOT NULL,
	);
	...
	Book_PublisherName VARCHAR(100) NOT NULL CONSTRAINT fk_Publisher_Name1 FOREIGN KEY REFERENCES table_Publisher(Publisher_Publisher_Name) ON UPDATE CASCADE ON DELETE CASCADE,
	);
	...
	Borrower_Card_No INT PRIMARY KEY NOT NULL IDENTITY (100,1),
	...
	CREATE TABLE tbl_book_loans (
		...
		book_loans_BranchID INT NOT NULL CONSTRAINT fk_branch_id1 FOREIGN KEY REFERENCES Table_Library_Branch(Library_Branch_Branch_ID) ON UPDATE CASCADE ON DELETE CASCADE,
		book_loans_CardNo INT NOT NULL CONSTRAINT fk_cardno FOREIGN KEY REFERENCES Table_Borrower(Borrower_Card_No) ON UPDATE CASCADE ON DELETE CASCADE,
	...
	CREATE TABLE tbl_book_copies (
		...
		book_copies_BranchID INT NOT NULL CONSTRAINT fk_branch_id2 FOREIGN KEY REFERENCES Table_Library_Branch(Library_Branch_Branch_ID) ON UPDATE CASCADE ON DELETE CASCADE,
	...
	INSERT INTO table_Publisher
		(Publisher_Publisher_Name, Publisher_Publisher_Address, Publisher_Publisher_PublisherPhone)
		VALUES
